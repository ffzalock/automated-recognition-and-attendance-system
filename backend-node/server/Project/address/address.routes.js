...
// const provinces = require("./service/provinces");
// const Provinces = require("../address/controller/provinces");

// router.get("/provinces", provinces.onQuerys);
// router.post("/provinces", provinces.onCreate);
// router.put("/provinces", provinces.onUpdate);
// router.delete("/provinces", provinces.onDelete);
...
//     }
// ].map(({ provinceCode, provinceNameTh, provinceNameEn }) => ({
//     code: provinceCode,
//     title: [
//         { key: "th", value: provinceNameTh },
//         { key: "en", value: provinceNameEn }
//     ]
// }))

// for(var i=0; i < objs.length; i++) {
//     console.log(objs[i]);
//     const doc =  Provinces.onCreate(objs[i]);
// }
