...
const HrSubUnitMasterSchema = new Schema({
    ...
    orgUnit: { type: Schema.ObjectId, ref: 'Setting_HR_OrgUnitMaster', default: null },
    source: { type: String, default: 'HR_IMPORT' },
    isActive: { type: Boolean, default: true }
}, { timestamps: true });

attachLocalizedVirtuals(HrSubUnitMasterSchema);
module.exports = mongoose.model('Setting_HR_SubUnitMaster', HrSubUnitMasterSchema, 'Setting_HR_SubUnitMaster');
