...
const HrWorkLineMasterSchema = new Schema({
...
attachLocalizedVirtuals(HrWorkLineMasterSchema);
module.exports = mongoose.model('Setting_HR_WorkLineMaster', HrWorkLineMasterSchema, 'Setting_HR_WorkLineMaster');
