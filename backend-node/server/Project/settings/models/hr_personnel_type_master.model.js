...
const HrPersonnelTypeMasterSchema = new Schema({
...
attachLocalizedVirtuals(HrPersonnelTypeMasterSchema);
module.exports = mongoose.model('Setting_HR_PersonnelTypeMaster', HrPersonnelTypeMasterSchema, 'Setting_HR_PersonnelTypeMaster');
