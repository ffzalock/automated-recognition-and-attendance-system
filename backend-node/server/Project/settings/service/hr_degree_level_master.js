'use strict';
const Controller = require('../controller/hr_degree_level_master');
...
module.exports = createHrMasterCrudService(Controller, {
    populate: [],
    dependencies: [
        { Model: HrPositionMaster, field: 'degreeLevelMaster', label: 'HR Position Master' },
        { Model: HrIdentityMaster, field: 'degreeLevelMaster', label: 'HR Identity Master' }
    ]
});
